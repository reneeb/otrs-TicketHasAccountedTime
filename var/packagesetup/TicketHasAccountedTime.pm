...
package var::packagesetup::TicketHasAccountedTime;
...
TicketHasAccountedTime.pm - code to excecute during package installation
...
sub _GetDynamicFieldsDefinition {
    ...
    my @DynamicFields = (
        {
            Name       => 'TicketHasAccountedTimes',
            Label      => 'Ticket has accounted time',
            FieldType  => 'Text',
            ObjectType => 'Ticket',
            Config     => {
                DefaultValue   => 0,
        ...
        {
            Name       => 'TicketAccountedTimes',
            Label      => 'Ticket accounted time',
            FieldType  => 'Text',
            ObjectType => 'Ticket',
            Config     => {
                DefaultValue   => 0,
